...
set C_NOWARN=/wd4100 /wd4189 /wd4065 /wd4505 /wd4101 /wd4244
...
cl %CFLAGS% /c ..\src\relwarb_utils.cpp
cl %CFLAGS% /c ..\src\relwarb_opengl.cpp
cl %CFLAGS% /c ..\src\win32_relwarb.cpp

link win32_relwarb.obj relwarb_opengl.obj relwarb_utils.obj relwarb.obj %LDFLAGS% /out:relwarb.exe
